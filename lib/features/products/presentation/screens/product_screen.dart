      ...
      child: Column(
        ...
        children: [
          ...
          _SizeSelector(
            ...
            onSizeChanged: ref.read(productFormProvider(product).notifier).onSizesChanged,
          ),
          const SizedBox(height: 5 ),
          _GenderSelector( 
            selectedGender: productForm.gender,
            onGenreSelected: ref.read(productFormProvider(product).notifier).onGenderChanged,
          ),
...
class _GenderSelector extends StatelessWidget {
  ...
  final void Function(String gender) onGenreSelected;
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SegmentedButton(
        ...
        onSelectionChanged: (newSelection) {
          onGenreSelected(newSelection.first);
        },
      ),
    );
  }
